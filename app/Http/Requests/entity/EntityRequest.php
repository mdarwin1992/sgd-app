...
class EntityRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'legal_representative' => 'nullable|string|max:100', // Validación del representante legal
            'employee_count' => 'nullable|integer',           // Validación del número de empleados
            'website' => 'nullable|url|max:100',              // Validación del sitio web
            'logo' => 'nullable|string|max:100',              // Validación del logo
            'status' => 'required|in:ACTIVO,INACTIVO',        // Validación del estado (activo o inactivo)
        ];
    }
