...
@section('content')
    <div data-permissions="business.create" class="visible">
        <div class="row pt-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Crear Nueva Entidad</h4>
                        ...
                        <form id="AddForm" name="AddForm" class="needs-validation" novalidate>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="/dashboard/empresa" class="btn btn-primary rounded-pill btn-tool me-2">
        ...
        const CreateEntity = (() => {
            ...
            const createEntity = async (event) => {
                ...
                if ($(elements.AddForm).valid()) {
                    ...
                    try {
                        const response = await HTTPService.post('/api/dashboard/entity/store',
                            formDataObject);
                        console.log(response)
                        Helpers.getMessage('Se ha guardado la entidad correctamente', '/dashboard/empresa');
                    } catch (error) {
            ...
            $(document).ready(() => {
                ...
                document.querySelector(elements.AddForm).addEventListener('submit', createEntity);
            });
