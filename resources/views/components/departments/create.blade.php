...
@section('content')
    <div data-permissions="departments.create" class="visible">
        <div class="row pt-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
    ...
    <script type="module">
        ...
        const DepartmentCreate = (() => {
            ...
            const createDepartment = async (event) => {
                ...
                if ($(elements.createDepartmentForm).valid()) {
                    isSubmitting = true;

                    const form = document.querySelector(elements.createDepartmentForm);
            ...
            const setupValidation = () => {
                ...
                $(elements.createDepartmentForm).validate({
                    rules: {
                        code: "required",
                        name: "required",
                        entity_id: "required",
            ...
            $(document).ready(() => {
                ...
                document.querySelector(elements.createDepartmentForm).addEventListener('submit', createDepartment);
            });
            ...
            window.DepartmentCreate = publicApi;
