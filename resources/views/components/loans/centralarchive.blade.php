...
@section('title', 'Prestamos documentales archivo central')
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xl-12 mb-3">
                            <div class="card mb-0 h-100">
                                <div class="card-body">
                                    <h4 class="header-title"> Prestamos documentales archivo central</h4>
...
@section('scripts')
    <script type="module">
        ...
        $(document).on('click', '.edit-icon', function() {
            ...
            if (archiveId) {
                document.getElementById('central_archive_id').value = archiveId
            }
        });
        ...
        async function save() {
            ...
            let central_archive_id = document.getElementById("central_archive_id").value;
