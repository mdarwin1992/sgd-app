...
@section('title', 'Crear Archivo central')

@section('content')
    <div data-permissions="centralfile.create" class="visible">
        <div class="row pt-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Archivo central</h4>
...
@section('scripts')
    <script type="module">
        ...
        const CentralArchive = (() => {
            ...
            const elements = {
                createCentralArchiveForm: '#AddForm',
            ...
            const createCentralArchive = async (event) => {
                ...
                if ($(elements.createCentralArchiveForm).valid()) {
                    isSubmitting = true;

                    const form = document.querySelector(elements.createCentralArchiveForm);
            ...
            const setupValidation = () => {
                ...
                $(elements.createCentralArchiveForm).validate({
                    rules: {
                        office_id: "required",
                        series_id: "required",
