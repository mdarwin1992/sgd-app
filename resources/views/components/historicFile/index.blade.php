...
@section('title', 'Gestión Archivo Histórico')

@section('content')
    <div data-permissions="historic.index">
        <div class="row pt-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <button type="button" class="btn btn-primary btn-sm"
                                        onclick="window.HistoricalArchive.showSearchModal()">
                                    Buscar Documento
                                </button>
                                <button type="button" class="btn btn-secondary btn-sm"
                                        onclick="window.HistoricalArchive.openSearchModal('box')">Buscar Por Caja
                                </button>
                                <button type="button" class="btn btn-info btn-sm"
                                        onclick="window.HistoricalArchive.openSearchModal('series')">Buscar por
                                    Serie
                                </button>
                                <button type="button" class="btn btn-success btn-sm"
                                        onclick="window.HistoricalArchive.showSigns()">
                                    Rotulos
                                </button>
                                <button type="button" class="btn btn-warning btn-sm"
                                        onclick="window.HistoricalArchive.openSearchModal('year')">Buscar Por Año
                                </button>
                                <button type="button" class="btn btn-danger btn-sm"
                                        onclick="window.HistoricalArchive.showDeleteModal()">
                                    Eliminar
                                </button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.HistoricalArchive.updateDocument()">
                        Guardar Cambios
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="window.HistoricalArchive.deleteDocument()">
                        Eliminar
                    </button>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <button onclick="window.HistoricalArchive.searchDocuments()" class="btn btn-primary">
...
@section('scripts')
    <script type="module">
        ...
        const HistoricalArchive = (() => {
                    ...
                    columns: [
                        {
                            ...
                            render: (data, type, row) =>
                                `<input type="checkbox" class="document-checkbox" data-codigo="${row.filed}" onclick="window.HistoricalArchive.toggleDocument(this, '${row.filed}')">`,
                            orderable: false
                        },
            ...
            const showSearchModal = async () => {
                ...
                try {
                    const response = await HTTPService.get(`/api/dashboard/historical-archive/find-document/${selectedCode}`);
            ...
            const generateDocumentHtml = (doc) => {
                ...
                const numero = ruta.match(/archivo_historico\/(\d+)\//);
                ...
                <div class="col-lg-12">
                        <div class="border p-1 mt-1 mt-lg-0 rounded">
                            ...
                            <div class="btn-group mb-2">
                                <button type="button" class="btn btn-warning" onclick="window.HistoricalArchive.downloadPDF(${numero ? numero[1] : ''})"> <i class="fas fa-download"></i> Descargar PDF</button>
        ...
        `;
            ...
            const downloadPDF = async (id) => {
                ...
                try {
                    ...
                    pdfViewer.src = `/storage/upload/archivo_historico/${id}/${id}.pdf`;
            ...
            const searchDocuments = async () => {
                ...
                try {
                    Swal.showLoading();
                    if (searchType === 'box') {
                        const response = await HTTPService.get(`/api/dashboard/historical-archive/search-by-box/${searchTerm}`);
                        if (response) {
                        ...
                        const response = await HTTPService.get(`/api/dashboard/historical-archive/search-by-serial/${searchTerm}`);
                        if (response) {
                            updateTable(response, searchType);
                        } else {
                            updateTable([], searchType);
                        ...
                        const response = await HTTPService.get(`/api/dashboard/historical-archive/search-by-year/${searchTerm}`);
                        if (response) {
                            updateTable(response, searchType);
                        } else {
                            updateTable([], searchType);
    ...
    `;
        ...
        `;
            ...
            window.HistoricalArchive = publicApi;
